...
public class ActorCrash extends UntypedActor {
	...
	public static void main(String[] args) {
		...
		final ActorRef crashRef = system
				.actorOf(Props.create(ActorCrash.class));
		final ActorRef dividingActorRef = system.actorOf(Props
				.create(DividingActor.class));
	...
	public void onReceive(Object message) throws Exception {
		System.out.printf("Recieved result: [%s]%n", message);
	}
